...
if(TensorRT_FOUND)
    ...
    if(NOT TensorRT_LIBRARIES)
        set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${TensorRT_NVONNXPARSER_LIBRARY} ${TensorRT_NVPARSERS_LIBRARY} ${TensorRT_NVINFER_PLUGIN_LIBRARY})
    endif()
    ...
    if(NOT TARGET TensorRT::NVINFER_PLUGIN)
        ...
        set_target_properties(TensorRT::NVINFER_PLUGIN PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${TensorRT_INCLUDE_DIRS}")
        set_property(TARGET TensorRT::NVINFER_PLUGIN APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_NVINFER_PLUGIN_LIBRARY}")
    endif()
endif()